...
const HomePage: React.FC<HomePageProps> = () => {
  ...
  const quickActions = [
    {
      ...
      titleHi: "लाइव क्लास में शामिल हों",
      titleRaj: "लाइव क्लास में जोड़ो",
      icon: Users,
      color: "bg-blue-500",
    },
    {
    ...
    },
    {
      ...
      titleHi: "अभ्यास परीक्षा",
      titleRaj: "अभ्यास परीक्षा",
      icon: Award,
      color: "bg-purple-500",
    },
    {
  ...
  const recentActivity = [
    ...
    {
      action: "Participated in discussion",
  ...
  const achievements = [
    {
      title: "Perfect Score",
      description: "Scored 100% in assignment",
      icon: "🏆",
      earned: true,
    },
    {
  ...
  const getQuickActionTitle = (action: { id: string, title: string, titleHi: string, titleRaj: string, icon: React.ElementType, color: string }) => {
    switch (language) {
      case "hi":
        return action.titleHi;
      case "raj":
        return action.titleRaj;
      default:
        return action.title;
    }
  };
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {quickActions.map((action) => {
            ...
            return (
              ...
              >
                <div
                  className={`w-12 h-12 ${action.color} rounded-xl flex items-center justify-center mb-3 mx-auto`}
                >
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950 dark:to-indigo-950 rounded-xl border border-blue-200 dark:border-blue-800 p-6">
        ...
        <div className="space-y-3">
          ...
          <div className="bg-white dark:bg-gray-800 p-3 rounded-lg">
            ...
            <p className="text-xs text-gray-600 dark:text-gray-400">
              Physics class starts in 30 minutes
            </p>
          </div>
        </div>
      </div>
